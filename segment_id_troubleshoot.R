...
ctg=readLAScatalog('C:/Users/jeffery.cannon/OneDrive - Joseph W. Jones Ecological Research Center/Desktop/unseg.laz')
opt_filter(ctg) = '-thin_with_voxel 0.025'
plot(ctg, chunk_pattern=TRUE)
chunk=engine_chunks(ctg)[[1]]
